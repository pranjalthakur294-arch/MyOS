...
C_SRCS   := $(SRC_DIR)/kernel/kernel.c $(SRC_DIR)/kernel/vga.c $(SRC_DIR)/kernel/idt.c $(SRC_DIR)/kernel/pic.c $(SRC_DIR)/kernel/keyboard.c $(SRC_DIR)/kernel/terminal.c $(SRC_DIR)/kernel/shell.c
